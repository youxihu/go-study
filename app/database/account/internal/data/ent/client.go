...
import (
	...
	"go-study/app/database/account/internal/data/ent/migrate"
...
func (c *Client) Intercept(interceptors ...Interceptor) {
	...
	c.AccountWallet.Intercept(interceptors...)
}
...
// UpdateOneID returns an update builder for the given id.
func (c *AccountWalletClient) UpdateOneID(id int32) *AccountWalletUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *AccountWalletClient) DeleteOneID(id int32) *AccountWalletDeleteOne {
...
func (c *AccountWalletClient) Get(ctx context.Context, id int32) (*AccountWallet, error) {
	return c.Query().Where(accountwallet.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AccountWalletClient) GetX(ctx context.Context, id int32) *AccountWallet {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
type (
	hooks struct {
		Account, AccountWallet []ent.Hook
	}
	inters struct {
		Account, AccountWallet []ent.Interceptor
	}
)
